...
//        }
    ...
    public static void FULL_PRESS_BEACON (AutonomousJorge jorge, AutonomousJorge.BEACON facingBeacon, SIDE side) throws InterruptedException {
        ...
        final boolean DO_FINAL_CORRECTION = true;
...
//        PRESS_BEACON( jorge, noTimes );
        ...
        if (side == SIDE.RED) {
            ...
            { RED_PRESS_BEACON(jorge, TurnToAngleTest.Direction.LEFT, DO_FINAL_CORRECTION); } else
            if ( jorge.vuforia.getBeaconConfig(facingBeacon.index) == Vuforia2017Manager.BLUE_RED )
            {RED_PRESS_BEACON(jorge, TurnToAngleTest.Direction.RIGHT, DO_FINAL_CORRECTION);}
            else { RED_PRESS_BEACON(jorge, TurnToAngleTest.Direction.RIGHT, DO_FINAL_CORRECTION); }
            jorge.vuforia.checkOnBeacons(facingBeacon.index);
            if (jorge.vuforia.getBeaconConfig(facingBeacon.index) == Vuforia2017Manager.BLUE_BLUE) {
            ...
            { BLUE_PRESS_BEACON(jorge, TurnToAngleTest.Direction.LEFT, DO_FINAL_CORRECTION); } else
            ...
            else { BLUE_PRESS_BEACON(jorge, TurnToAngleTest.Direction.RIGHT, DO_FINAL_CORRECTION); }
            jorge.vuforia.checkOnBeacons(facingBeacon.index);
            if (jorge.vuforia.getBeaconConfig(facingBeacon.index) == Vuforia2017Manager.RED_RED) {
